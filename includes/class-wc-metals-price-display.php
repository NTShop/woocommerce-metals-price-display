...
class WC_Metals_Price_Display {
	...
	public function inject_timer_script() {
		...
		wp_enqueue_script( 'metals-price-updater', plugin_dir_url( WC_METALS_PLUGIN_FILE ) . 'assets/js/metals-price-updater.js', array( 'jquery' ), METALS_UPDATER_VERSION, true );
